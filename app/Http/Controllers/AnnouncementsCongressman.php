...
class AnnouncementsCongressman extends Controller
{
    ...
    public function index()
    {
        ...
        $programs_cong = News::where('status', 1)
               ...
               ->orderBy('created_at')
               ->get();
        return view('admin.congressman.announcements.announcement_list', compact('programs_cong'));
        //
    }
    ...
    {
        return view('admin.congressman.announcements.announcement_create');
    ...
    public function store(Request $request)
    {
        ...
        //to redirect
        return redirect()->route('admin.congressman.announcements.announcement_list')->with('success','Data Added');
    }
    ...
    {
        $news = news::find($id); 
        return view('admin.congressman.announcements.announcement_edit',compact('news', 'id'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $update->save();
        return redirect()->route('admin.congressman.announcements.announcement_list')->with('success','Data Updated');
