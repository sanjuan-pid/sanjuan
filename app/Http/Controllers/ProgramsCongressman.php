...
class ProgramsCongressman extends Controller
{
    ...
    public function index()
    {
        ...
        $programs_cong = News::where('status', 1)
               ...
               ->get();
        // echo $programs_cong;
        return view('admin.congressman.programs.prog_list', compact('programs_cong'));
        //
    }
    ...
    {
        return view('admin.congressman.programs.prog_create');
    ...
    public function store(Request $request)
    {
        ...
        //to redirect
        return redirect()->route('admin.congressman.programs.prog_list')->with('success','Data Added');
    }
    ...
    {
        $news = news::find($id); 
        return view('admin.congressman.programs.prog_edit',compact('news', 'id'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $update->save();
        return redirect()->route('admin.congressman.programs.prog_list')->with('success','Data Updated');
    ...
    public function destroy($id)
    {
        ...
        $news->status = 0;
        $news->save();
        return redirect()->route('admin.congressman.programs.prog_list')->with('success', 'Program is already removed');
    }
