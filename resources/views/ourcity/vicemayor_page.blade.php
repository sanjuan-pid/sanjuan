...
@section('content')
    ...
    <div class="container" id="vicempage">
        <div class="container" id="vicepic" style="max-width: 100%;">
          <div class="row">
            <div class=" col-12 col-sm-12">
              <img id="vm_pic" src="{{asset('assets/vice/vice2.png')}}"style="width:70%; position: relative; height:95% !important; z-index:-1; display: block; margin-left: auto; margin-right: auto;border-radius: 10px;"/>
            </div>
          </div>
        </div>
       ...
       <div class="container" style="max-width: 60%; z-index: 4; margin-top: -13.8%;">
          <div class="row" id="profile_row">
           <div class=" col-12 col-sm-12">
            <div class="c">
              ...
              <h1 class="pf" style="font-size:40px; margin-top:200px;">BIOGRAPHY</h1>
        ...
        <div class="container ac" style="margin-top:200px;">
        ...
        <div class="container ag"style="margin-top:200px;">
