       ...
       <div class="container" style="max-width: 60%; z-index: 4; margin-top: -13.8%;">
        ...
        <div class="container">
          <div class="row" id="achievement_row" style="margin-top: -28%;">
            <h2 class="card-title" style="font-weight: 800; font-size: 40px;"><img src={{asset('assets/achievement.svg')}} style="width: 5%; vertical-align: baseline;"/> ACHIEVEMENTS </h2>

            @foreach ($achievement as $ach)
            <div class="col-sm-4" style="margin-top:2%;">
              <div class="card">
                      <div class="card-body">
                          <h5 class="card-title" style="font-weight: 800; font-size: 40px;">{{$ach->title}}</h5>
        ...
        <div class="container">
          <div class=" col-12 col-sm-12" id="agenda_row">
                <div class="sj">
                  <h2 class="card-title" style="font-weight: 800; font-size: 40px;"><img src={{asset('assets/porfolio.svg')}} style="width: 5%; vertical-align: baseline;"/> PROGRAMS </h2>
                            ...
                            <div class="card">
                              <div class="card-body">
                                <div class="sj" style="margin-top: 0; text-align: center;">
                                    <h1  id="vicesoc" style="font-size:30px;">FACEBOOK</h1>
                                    <div id="fb-root"></div>
                                    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v10.0" nonce="ayCIKFhZ"></script>
                                    <iframe  src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fvicemayorwarrenvilla%2F&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=true&show_facepile=true&appId" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                    </div>
                                  </div>
                               </div>
                            </div>
