...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
        <div class="container" id="con1" style="max-width: 70%; background-color:white;">
          <div class="row">
            <div class=" col-8 col-sm-8 col-md-8 col-lg-8" class="block">
              <div class="row" style="cursor:pointer;">
                <div class=" col-12 col-sm-12 col-md-12 col-lg-12" class="block">
                  ...
                  <h1 class="t1" style=" font-weight:bold; color: #1f1c4b;">History of San Juan</h1>
                    <div id="prgph0">
                      <p style=" font-weight: 500; margin-top: 15px;text-indent: 50px;line-height: 200%;">Nestled in the heart of Metro Mania, between Manila, Pasig, Mandaluyong, and Quezon City is a city rich in history. With a land area of merely 5.94 square kilometers and the shape of a heart, San Juan City is the smallest city in Metro Manila, Philippines. It has 21 barangays and a population of over 122,000 based on the 2015 census. </p>
                      <div><img src="{{asset('assets/mP.png')}}"  style="width: 100%; border-radius: 5px;"/></div>
                    </div>
                </div>
                  ...
                  <div id="prgph2" >
                    ...
                    <!-- <div class="row">
                      <div class=" col-7 col-sm-7 col-md-7 col-lg-7">
                        <div><img src="{{asset('assets/landmark/eldepo.png')}}"  style="width: 60%; border-radius: 5px;"/></div>
                      </div>
                    <div class=" col-5 col-sm-5 col-md-5 col-lg-5">
                      <div><img src="{{asset('assets/landmark/el_polvorin.png')}}"  style="width: 100%; border-radius: 5px;"/></div>
                    </div>
                  </div> -->
                </div>
              </div>
            ...
            <div class=" col-4 col-sm-4 col-md-4 col-lg-4 mt-3" class="block">
              <div class="item" style="margin-left:25%;"><img src="{{asset('assets/pinag.png')}}"/></div>
            </div>
          </div>
        </div>
        <br><br><br><br>
