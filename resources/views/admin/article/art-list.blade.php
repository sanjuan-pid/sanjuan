        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">Articles
                    <a href="{{action('ArticleController@create')}}" class="btn btn-success" style="color:#fff; float:right;">Add New</a>
                </div>
                         ...
                         @foreach($act as $row)
                                <tr id={{$row->id}}>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{action('ArticleController@edit', $row->id)}}" class="btn btn-info" style="color:#fff;">Edit</a>
                                        <form method="post" class="delete_form" action="{{action('ArticleController@destroy',$row->id)}}" >
                                            {{csrf_field()}}
