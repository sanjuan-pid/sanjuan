    ...
    <div class="header pb-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 d-inline-block mb-0">DEPARTMENTS - CREATE</h6>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input required type="text" name="code" class="form-control" id="staticEmail" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input required type="text" class="form-control" id="example3cols2Input" name="contact_no">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label class="form-control-label" for="example3cols3Input">Email</label>
                <input required type="text" class="form-control" id="example3cols3Input" name="email">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-sm-4 col-md-4">
              <div class="form-group">
                ...
                <input required type="text" class="form-control" id="staticEmail" name="depthead">
              </div>
            </div>
            <div class="col-sm-4 col-md-4">
              <div class="form-group">
                <label class="form-control-label" for="staticEmail">Designation</label>
                <input required type="text" class="form-control" id="staticEmail" name="designation">
              </div>
            </div>
            <div class="col-sm-4 col-md-4">
              <div class="form-group">
