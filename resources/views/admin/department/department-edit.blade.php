                ...
                <div class="card-body">
                  <form method="post" action="{{action('DeparmentController@update', $id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name ="title" class="form-control" value="{{$dept->title}}">
                        </div>
                      </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                             <div id="editor">
                              ...
                              <textarea  rows="10" id="description" hidden name ="description" class="form-control">{{$dept->description}}</textarea>
                        </div>
                    </div>
                    <br> <br>                   
