                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{action('Department_MainController@update',$id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="name" class="form-control" id="staticEmail" value="{{$item->dept_name}}" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Office Code</label>
                        <div class="col-sm-10">
                          <input type="text" name="code" class="form-control" id="staticEmail" value="{{$item->dept_code}}" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="sector" class="form-control" id="staticEmail" value="{{$item->dept_sector}}" >
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                          <input type="text"   name ="contact_no" class="form-control" id="staticEmail" value="{{$item->dept_contactno}}" >
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Email Address</label>
                      <div class="col-sm-10">
                        <input type="text"   name ="email" class="form-control" id="staticEmail" value="{{$item->dept_email}}">
                      </div>
                  </div>
                  <hr>
                    <div class="form-group row mt-4">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="depthead" class="form-control" id="staticEmail" value="{{$item->member_name}}" >
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Designation</label>
                      <div class="col-sm-10">
                        <input type="text" name="designation" class="form-control" id="staticEmail" value="{{$item->member_designation}}" >
                      </div>
                  </div>
                  <div class="form-group row">
