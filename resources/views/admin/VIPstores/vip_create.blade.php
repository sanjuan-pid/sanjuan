...
<link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
    ...
    <div class="header pb-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 d-inline-block mb-0">CITY / VIP STORES - CREATE</h6>
            </div>
    ...
    <div class="container-fluid mt--6">
      <!-- Form Content -->
      <form method="post" action="{{action('Admin_VIPController@store')}}" enctype="multipart/form-data" id="Form_VIPStore">
        {{csrf_field()}}
      <div class="card">
        <!-- Card header -->
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input required type="text" class="form-control" name ="establishment">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="mb-3">
                <input name="offers" type="hidden" value="">
