    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-header">Mayor's Achievements
                    <a href="{{action('AchievementsController@create')}}?content_type=mayors" class="btn btn-success" style="color:#fff; float:right;">Add New</a>
                </div>
