...
<link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
    ...
    <div class="header pb-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 d-inline-block mb-0">BARANGAY - EDIT</h6>
            </div>
    ...
    <div class="container-fluid mt--6">
      <!-- Form Content -->
      <form method="post" action="{{action('Brgy_ContentController@update',$id)}}" enctype="multipart/form-data" id="Form_Brgy">
      {{csrf_field()}}
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input required type="text" name="brgyname" class="form-control" id="brgyname" value="{{$Brgy->brgy_name}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-control-label" for="brgylogo">Barangay Logo</label>
                <input type="hidden" name ="brgylogo_" class="form-control" id="staticEmail" value="{{$Brgy->brgy_logo}}">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="brgylogo" lang="en" name="brgylogo" value="{{$Brgy->brgy_logo}}">
                    <label class="custom-file-label" for="brgylogo">{{$Brgy->brgy_logo}}</label>
                  </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input required type="text" name="brgycontact" class="form-control" id="brgycontact" value="{{$Brgy->brgy_contact}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-control-label" for="brgyemail">Barangay Email Address</label>
                <input type="text" name="brgyemail" class="form-control" id="brgyemail" value="{{$Brgy->brgy_email}}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="mb-3">
                <input name="brgyabout" id="brgyabout" type="hidden" value="{{$Brgy->brgy_about}}">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="mb-3">
                <input name="brgymission" id="brgymission" type="hidden" value="{{$Brgy->brgy_mission}}">
            ...
            <div class="col-md-6">
              ...
              <div class="mb-3">
                <input name="brgyvision" id="brgyvision" type="hidden" value="{{$Brgy->brgy_vision}}">
          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <input type="hidden" name ="brgycharter_" class="form-control" id="staticEmail" value="{{$Brgy->brgy_citizencharter}}">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="brgycharter" lang="en" name="brgycharter" value="{{$Brgy->brgy_citizencharter}}">
                    <label class="custom-file-label" for="brgycharter">{{$Brgy->brgy_citizencharter}}</label>
                  </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <input type="hidden" name ="brgyorg_" class="form-control" id="staticEmail" value="{{$Brgy->brgy_orgchart}}">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="brgyorg" lang="en" name="brgyorg" value="{{$Brgy->brgy_orgchart}}">
                    <label class="custom-file-label" for="brgyorg">{{$Brgy->brgy_orgchart}}</label>
                  </div>
              </div>
            </div>
          </div>
