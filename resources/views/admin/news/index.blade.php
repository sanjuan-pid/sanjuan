    ...
    <div class="header pb-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 d-inline-block mb-0">MAYORS / NEWS</h6>
            </div>
            <div class="col-lg-6 col-5 text-right">
                <a href="{{action('NewsController@create')}}" class="btn btn-success"><i class="fa fa-plus fa-fw"></i> News</a>
            </div>
            </div>
        </div>
        </div>
                    ...
                    <tbody class="list" id="search-show">
                      @foreach($news as $row)
                        <tr id={{$row->id}} class="search-group">
                            ...
                            <td>
                                <a href="{{action('NewsController@edit', $row->id)}}" class="btn btn-primary mb-1 btn-block font-weight-bold btn-sm">Edit</a>
                                @if($row->show != 1)
