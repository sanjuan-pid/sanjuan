    ...
    <div class="header pb-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 d-inline-block mb-0">CITY / ACTIVITY</h6>
            </div>
            <div class="col-lg-6 col-5 text-right">
                <a href="{{action('ActivityController@create')}}" class="btn btn-success"><i class="fa fa-plus fa-fw"></i> Add Activity</a>
            </div>
            </div>
        </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    ...
                    <thead class="thead-light">
                        ...
                        <th scope="col" class="sort" data-sort="budget">Date Posted</th>
                    ...
                    <tbody class="list" id="search-show">
                      @foreach($act as $row)
                        <tr id={{$row->id}} class="search-group">
                            ...
                            <td>
                                <a href="{{action('ActivityController@edit', $row->id)}}" class="btn btn-primary mb-1 btn-block font-weight-bold btn-sm">Edit</a>
