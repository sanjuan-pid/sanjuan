...
<link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
    ...
    <div class="header pb-6">
        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                <h6 class="h2 d-inline-block mb-0">CITY / ACTIVITY - CREATE</h6>
            </div>
    ...
    <div class="container-fluid mt--6">
      <!-- Form Content -->
      <form method="post" action="{{action('ActivityController@store')}}" enctype="multipart/form-data" id="Form_Activity">
        {{csrf_field()}}
      <div class="card">
        <!-- Card header -->
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input required type="text" class="form-control" id="Act_Title" name="Act_Title">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-control-label" for="Act_Image">Upload Image</label>
                  <div class="custom-file">
                    <input required type="file" class="custom-file-input" id="Act_Image" lang="en" name="Act_Image">
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <div class="mb-3">
                  <input name="Act_Desc" type="hidden" value="">
